  ...
  return (
    <div>
      ...
      <div className="bg-black text-white w-screen h-screen flex flex-col justify-center items-center">
        <div className="bg-[#111214] text-center space-y-6 md:space-y-10 px-10 md:px-16 rounded-2xl border border-[#343A40]">
          <div className="">
            <div className="text-md md:text-xl font-semibold mt-6">
